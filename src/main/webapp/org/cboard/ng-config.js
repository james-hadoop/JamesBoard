...
angular.module('cBoard').config([ '$stateProvider', function($stateProvider) {
	...
	}).state('config.JamesConfig', {
		url : '/datasource',
		templateUrl : 'org/cboard/view/config/JamesConfig.html',
		controller : 'JamesConfigCtrl'
...
angular.module('cBoard').factory('sessionHelper',
