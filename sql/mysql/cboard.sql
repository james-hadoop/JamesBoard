...
--
-- Host: 127.0.0.1    Database: cboard
-- ------------------------------------------------------
...
INSERT INTO `dashboard_board` VALUES (1,'1',1,'student_1','{\"rows\":[{\"type\":\"widget\",\"widgets\":[{\"name\":\"dashboard_student_1\",\"widgetId\":1,\"width\":12}]}]}');
...
INSERT INTO `dashboard_category` VALUES (1,'telenav','1');
...
INSERT INTO `dashboard_dataset` VALUES (1,'1','Default Category','telenav_student','{\"datasource\":1,\"expressions\":[],\"query\":{\"sql\":\"select * from student;\"}}');
...
INSERT INTO `dashboard_datasource` VALUES (1,'1','telenav','jdbc','{\"driver\":\"com.mysql.jdbc.Driver\",\"jdbcurl\":\"jdbc:mysql://localhost:3306/telenav\",\"password\":\"\",\"username\":\"root\"}');
...
INSERT INTO `dashboard_widget` VALUES (1,'1','Default Category','student_1','{\"config\":{\"chart_type\":\"line\",\"filters\":[],\"groups\":[],\"keys\":[{\"col\":\"name\",\"type\":\"eq\",\"values\":[]}],\"selects\":[\"id\",\"age\",\"city\",\"birthday\"],\"valueAxis\":\"vertical\",\"values\":[{\"cols\":[{\"aggregate_type\":\"sum\",\"col\":\"score\"}],\"name\":\"\",\"series_type\":\"stackbar\",\"type\":\"value\"}]},\"datasetId\":1}');
...
-- Dump completed on 2017-04-12 15:25:11
